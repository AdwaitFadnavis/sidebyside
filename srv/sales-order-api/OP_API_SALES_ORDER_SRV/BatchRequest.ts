...
/**
 * Batch builder for operations supported on the Op Api Sales Order Srv.
 * @param requests The requests of the batch
 * @returns A request builder for batch.
 */
export function batch<DeSerializersT extends DeSerializers>(
  ...requests: Array<
    | ReadOpApiSalesOrderSrvRequestBuilder<DeSerializersT>
...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultOpApiSalesOrderSrvPath,
    transformVariadicArgumentToArray(first, rest)
  );
}

/**
 * Change set constructor consists of write operations supported on the Op Api Sales Order Srv.
 * @param requests The requests of the change set
 * @returns A change set for batch.
 */
export function changeset<DeSerializersT extends DeSerializers>(
  ...requests: Array<WriteOpApiSalesOrderSrvRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  requests: Array<WriteOpApiSalesOrderSrvRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteOpApiSalesOrderSrvRequestBuilder<DeSerializersT>
    | Array<WriteOpApiSalesOrderSrvRequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteOpApiSalesOrderSrvRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
  return new BatchChangeSet(transformVariadicArgumentToArray(first, rest));
}

export const defaultOpApiSalesOrderSrvPath =
  '/sap/opu/odata/sap/API_SALES_ORDER_SRV';
export type ReadOpApiSalesOrderSrvRequestBuilder<
...
> =
  ...
  | GetByKeyRequestBuilder<
      ...
      DeSerializersT
    >;
export type WriteOpApiSalesOrderSrvRequestBuilder<
  DeSerializersT extends DeSerializers
> =
